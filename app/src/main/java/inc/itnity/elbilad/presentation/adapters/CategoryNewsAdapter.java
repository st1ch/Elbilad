...
public class CategoryNewsAdapter
    extends RecyclerView.Adapter<CategoryNewsAdapter.SimpleNewsViewHolder> {
  ...
  @Inject CategoryNewsAdapter(ImageLoaderHelper imageLoaderHelper, ElbiladUtils elbiladUtils,
  ...
  @Override public int getItemViewType(int position) {
    if (position == 0) {
      return TYPE_TOP;
    } else if (getItem(position).getType() == ArticleItem.TYPE.BANNER_100) {
