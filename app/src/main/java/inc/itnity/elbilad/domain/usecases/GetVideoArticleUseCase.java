...
public class GetVideoArticleUseCase extends UseCase<Video> {

  private ElbiladRepository elbiladRepository;

  private String videoId;

  @Inject GetVideoArticleUseCase(SubscribeOn subscribeOn, ObserveOn observeOn,
  ...
  @Override protected Observable<Video> getUseCaseObservable() {
    return elbiladRepository.getVideoArticle(videoId);
  }
}
