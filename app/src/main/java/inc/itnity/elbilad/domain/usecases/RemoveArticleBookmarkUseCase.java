...
public class RemoveArticleBookmarkUseCase extends UseCase<Bookmark> {

  private ElbiladRepository elbiladRepository;

  private Article article;

  @Inject RemoveArticleBookmarkUseCase(SubscribeOn subscribeOn, ObserveOn observeOn,
  ...
  @Override protected Observable<Bookmark> getUseCaseObservable() {
    return elbiladRepository.removeBookmark(new Bookmark(article));
  }
}
